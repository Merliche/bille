...
'''
defilY = Scrollbar(fen, orient='vertical',
    command=dessin.yview)
defilY.grid(row=0, column=1, sticky='ns')

defilX = Scrollbar(fen, orient='horizontal',
    command=dessin.xview)
defilX.grid(row=1, column=0, sticky='ew')

dessin['xscrollcommand'] = defilX.set
dessin['yscrollcommand'] = defilY.set
